...
from PySide6.QtWidgets import (QApplication, QLabel, QMainWindow, QPushButton, QWidget, QLineEdit, QVBoxLayout,
                               QHBoxLayout, QSizePolicy, QComboBox, QGridLayout, QRadioButton)
...
class Form(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.layout_hori.addWidget(self.canvas)
        ...
        self.edit = QLineEdit("../images/Lenna.jpg")
        self.edit.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)

        #image, video, webcam의 유형 선택을 위한 radiobutton 선언
        self.radiobtn1 = QRadioButton("Image")
        self.radiobtn2 = QRadioButton("Video")
        self.radiobtn3 = QRadioButton("Webcam")
        ...
        self.layout_hori2.addLayout(self.radiolayout)
    ...
    def load_img_func(self):
        if self.radiobtn1.isChecked() is True:
            self.MODE_VIDEO = False
            ...
            self.update_img(self.m_proc_img)
            print("update image")
        elif self.radiobtn2.isChecked() is True:
            self.MODE_VIDEO = True
            self.setup_camera(f"{self.edit.text()}")
        elif self.radiobtn3.isChecked() is True:
            self.MODE_VIDEO = True
            self.setup_camera(0)
